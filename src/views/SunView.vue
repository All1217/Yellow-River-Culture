        ...
        <div class="container">
            <div class="left-panel">
                ...
                <div class="filter-options">
                    <label><input type="checkbox" class="period-checkbox" value="古代发展萌芽期" v-model="selectedPeriods" />
                        萌芽期</label>
                    <label><input type="checkbox" class="period-checkbox" value="古代发展繁荣期" v-model="selectedPeriods" />
                        繁荣期</label>
                    <label><input type="checkbox" class="period-checkbox" value="古代向现代转变期" v-model="selectedPeriods" />
                        转型期</label>
                    <label><input type="checkbox" class="period-checkbox" value="现代发展繁荣期" v-model="selectedPeriods" />
                        现代期</label>
                </div>
            </div>
            <div class="right-panel">
                <div class="chart-container">
                    ...
                    <div id="lineChart" style="height: 100%;" @mouseenter="onLineChartEnter"
                        @mouseleave="onLineChartLeave"></div>
                </div>
